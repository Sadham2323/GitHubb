...
public class Launchm3 extends BaseClass{
	...
	private void test1() throws Exception {
		...
		List<WebElement> t2 = 
				d.findElements(By.xpath("(//table)[5]//following-sibling::tr/td[2]//input"));
		for(int i=0;i<t2.size();i++) {
			String txt = t2.get(i).getText();
			System.out.println(txt);
			if(txt.contains(bid)) {	
				List<WebElement> t3 = 
						d.findElements(By.xpath("(//table)[5]//following-sibling::tr/td[1]//input"));
				t3.get(t3.size()-1).click();
